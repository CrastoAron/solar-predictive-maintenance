...
Phase 1: Synthetic dataset generated by generate_dataset.py for initial training.
Phase 2: Real ESP32 sensor dataset collected over 6 weeks (Week1 to Week6) 
containing actual voltage, current, temperature, humidity, and light readings 
from a 12W solar panel. Models are currently trained on this real dataset. 
